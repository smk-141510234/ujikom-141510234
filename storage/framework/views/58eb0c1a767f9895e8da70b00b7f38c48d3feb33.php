        ...
        <div class="col-md-6 col-md-offset-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                            ...
                            <div class="col-md-6">
                            <div class="form-group <?php echo e($errors->has('nip') ? 'has-errors':'message'); ?>" >
                                <input id="nip" type="text" class="form-control" name="nip" value="<?php echo e(old('nip')); ?>"  autofocus></input>
